...
const cardDatabase = [
    { id: 'm1', name: 'Hivebyte Luxling', type: 'monster', icon: 'fa-lightbulb', levelReq: 1.0, descReal: "Lumière : Émet un éclat aveuglant pour désorienter l'adversaire.", descVirtual: "Data Recovery : Restaure des données perdues.", atkRatio: 0.2, defRatio: 0.8, spdRatio: 0.8, recRatio: 0.5 },
    { id: 'm2', name: 'Hivebyte Centipuls', type: 'monster', icon: 'fa-bugs', levelReq: 2.0, descReal: "Mille-pattes : Enserre la cible de ses multiples pattes et la frappe en rafale.", descVirtual: "Search Index : Scanne la base pour un script.", atkRatio: 0.6, defRatio: 0.6, spdRatio: 0.5, recRatio: 0.3 },
    { id: 'm3', name: 'Hivebyte Webforge', type: 'monster', icon: 'fa-spider', levelReq: 2.5, descReal: "Araignée : Piège la cible dans sa toile, entravant ses mouvements.", descVirtual: "Firewall Breach : Force l'ouverture des ports.", atkRatio: 0.3, defRatio: 0.9, spdRatio: 0.3, recRatio: 0.6 },
    { id: 'm4', name: 'Hivebyte Glimmerwing', type: 'monster', icon: 'fa-sun', levelReq: 3.0, descReal: "Coccinelle : Vole à toute vitesse autour de la cible et mord une zone découverte.", descVirtual: "Data Mining : Analyse flux pour info bonus.", atkRatio: 0.1, defRatio: 0.2, spdRatio: 0.7, recRatio: 0.2 },
    { id: 'm5', name: 'Hivebyte Ryder-Log', type: 'monster', icon: 'fa-motorcycle', levelReq: 3.5, descReal: "Cavalier : Charge à pleine vitesse et transperce l'adversaire de sa corne.", descVirtual: "Rootkit Driver : Contourne protections natives.", atkRatio: 0.8, defRatio: 0.4, spdRatio: 0.9, recRatio: 0.2 },
    { id: 'm6', name: 'Hivebyte Nebulworm', type: 'monster', icon: 'fa-worm', levelReq: 4.0, descReal: "Ver : Se scinde en deux sous le choc, chaque moitié continuant de combattre.", descVirtual: "Worm Replica : Crée copie fantôme.", atkRatio: 0.5, defRatio: 0.5, spdRatio: 0.2, recRatio: 0.8 },
    { id: 'm7', name: 'Hivebyte Sparkwasp', type: 'monster', icon: 'fa-bolt', levelReq: 4.2, descReal: "Guêpe : Assène une piqûre électrifiée qui transperce toute protection.", descVirtual: "Penetration Tester : Diagnostic offensif.", atkRatio: 0.9, defRatio: 0.2, spdRatio: 0.8, recRatio: 0.2 },
    { id: 'e1', name: 'Hivecore Vector-20', type: 'evo', icon: 'fa-star', levelReq: 3.0, descReal: "Fourmi : Frappe avec une force décuplée grâce à ses mandibules surpuissantes.", descVirtual: "System Overclock : Boost cadence processus.", atkRatio: 0.8, defRatio: 0.8, spdRatio: 0.7, recRatio: 0.4 },
    { id: 'e2', name: 'Hivecore Scarabank', type: 'evo', icon: 'fa-shield-halved', levelReq: 3.5, descReal: "Scarabée Tank : Encaisse le choc grâce à sa carapace blindée et tient sa position.", descVirtual: "Packet Sniffer : Bloque paquets suspects.", atkRatio: 0.7, defRatio: 1.0, spdRatio: 0.4, recRatio: 0.9 },
    { id: 'e3', name: 'Hivecore Coredrill', type: 'evo', icon: 'fa-dungeon', levelReq: 5.0, descReal: "Foreur : Perce la garde adverse de sa foreuse et projette l'adversaire au sol.", descVirtual: "Kernel Panic : Force reboot sous-système.", atkRatio: 0.9, defRatio: 0.7, spdRatio: 0.6, recRatio: 0.5 },
    { id: 'e4', name: 'Hivecore Rhinovault', type: 'evo', icon: 'fa-chess-rook', levelReq: 6.5, descReal: "Colosse : Charge et percute toutes les cibles à portée de sa masse blindée.", descVirtual: "System Purge : Nettoyage disque complet.", atkRatio: 1.0, defRatio: 1.0, spdRatio: 0.7, recRatio: 1.0 },
    { id: 's1', name: 'Hive Broadcast', type: 'spell', icon: 'fa-tower-broadcast', levelReq: 1.5, descReal: "Diffusion : Déclenche une évolution instantanée en plein combat.", descVirtual: "Hotfix Patch : Mise à jour critique instantanée." },
    { id: 's2', name: 'Lag Trip', type: 'spell', icon: 'fa-person-falling', levelReq: 4.0, descReal: "Ralentit l'adversaire, le forçant à rester sur la défensive.", descVirtual: "Lag Switch : Force mode 'Veille'." },
    { id: 's3', name: 'Cache Purge', type: 'spell', icon: 'fa-tombstone', levelReq: 2.5, descReal: "Un essaim submerge l'adversaire et le neutralise temporairement.", descVirtual: "Cache Dump : Envoie données en cache." },
    { id: 's4', name: 'Signal Squall', type: 'spell', icon: 'fa-wind', levelReq: 3.0, descReal: "Annule une attaque énergétique.", descVirtual: "Process Kill : Termine application." },
    { id: 't1', name: 'Hive Recall', type: 'trap', icon: 'fa-kit-medical', levelReq: 2.0, descReal: "Rappelle 2 insectes en renfort immédiat.", descVirtual: "Backup Restore : Restauration système." },
    { id: 't2', name: 'Reflect Protocol', type: 'trap', icon: 'fa-mirror', levelReq: 5.0, descReal: "Miroir : Renvoie une attaque physique vers le lanceur.", descVirtual: "DDoS Reflection : Renvoie trafic malveillant." }
];
...
gradient.addColorStop(0, 'rgba(234, 179, 8, 0.5)'); gradient.addColorStop(1, 'rgba(37, 99, 235, 0.1)'); // Yellow/Blue
let radarChart = new Chart(ctx, {
    type: 'radar',
    data: {
        labels: ['POWER', 'DEFENSE', 'SPEED', 'RECOVERY', 'TRICK'],
        datasets: [{ label: 'Stats', data: [1, 1, 1, 1, 1], backgroundColor: gradient, borderColor: '#eab308', borderWidth: 2, pointBackgroundColor: '#fff', pointBorderColor: '#2563eb' }]
    },
    options: {
...
function updateUI(levelVal) {
    ...
    studentId.innerText = `CIV-${Math.floor(level * 1024 + 500)}-DB`;
