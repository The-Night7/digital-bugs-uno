...
const cardDatabase = [
    { id: 'm1', name: 'Hivebyte Luxling', type: 'monster', icon: 'fa-lightbulb', levelReq: 1.0, descReal: "Lumière : Rappelle un insecte neutralisé pour renforcer le combat.", descVirtual: "Data Recovery : Restaure des données perdues.", atkRatio: 0.2, defRatio: 0.8, spdRatio: 0.8, recRatio: 0.5 },
    { id: 'm2', name: 'Hivebyte Centipuls', type: 'monster', icon: 'fa-bugs', levelReq: 2.0, descReal: "Mille-pattes : Fait surgir un insecte supplémentaire en changeant de posture.", descVirtual: "Search Index : Scanne la base pour un script.", atkRatio: 0.6, defRatio: 0.6, spdRatio: 0.5, recRatio: 0.3 },
    { id: 'm3', name: 'Hivebyte Webforge', type: 'monster', icon: 'fa-spider', levelReq: 2.5, descReal: "Araignée : Emprisonne la cible dans une toile, annulant sa garde.", descVirtual: "Firewall Breach : Force l'ouverture des ports.", atkRatio: 0.3, defRatio: 0.9, spdRatio: 0.3, recRatio: 0.6 },
    { id: 'm4', name: 'Hivebyte Glimmerwing', type: 'monster', icon: 'fa-sun', levelReq: 3.0, descReal: "Coccinelle : Repère une faille et révèle une opportunité d'attaque.", descVirtual: "Data Mining : Analyse flux pour info bonus.", atkRatio: 0.1, defRatio: 0.2, spdRatio: 0.7, recRatio: 0.2 },
    { id: 'm5', name: 'Hivebyte Ryder-Log', type: 'monster', icon: 'fa-motorcycle', levelReq: 3.5, descReal: "Cavalier : Confère à l'unité évoluée une force capable de percer les défenses.", descVirtual: "Rootkit Driver : Contourne protections natives.", atkRatio: 0.8, defRatio: 0.4, spdRatio: 0.9, recRatio: 0.2 },
    { id: 'm6', name: 'Hivebyte Nebulworm', type: 'monster', icon: 'fa-worm', levelReq: 4.0, descReal: "Ver : Se scinde et fait apparaître un clone de combat.", descVirtual: "Worm Replica : Crée copie fantôme.", atkRatio: 0.5, defRatio: 0.5, spdRatio: 0.2, recRatio: 0.8 },
    { id: 'm7', name: 'Hivebyte Sparkwasp', type: 'monster', icon: 'fa-bolt', levelReq: 4.2, descReal: "Guêpe : Pique avec une force capable de percer les défenses adverses.", descVirtual: "Penetration Tester : Diagnostic offensif.", atkRatio: 0.9, defRatio: 0.2, spdRatio: 0.8, recRatio: 0.2 },
    { id: 'e1', name: 'Hivecore Vector-20', type: 'evo', icon: 'fa-star', levelReq: 3.0, descReal: "Fourmi : Augmente fortement la puissance d'attaque.", descVirtual: "System Overclock : Boost cadence processus.", atkRatio: 0.8, defRatio: 0.8, spdRatio: 0.7, recRatio: 0.4 },
    { id: 'e2', name: 'Hivecore Scarabank', type: 'evo', icon: 'fa-shield-halved', levelReq: 3.5, descReal: "Scarabée Tank : Bloque une capacité adverse et prend une posture défensive.", descVirtual: "Packet Sniffer : Bloque paquets suspects.", atkRatio: 0.7, defRatio: 1.0, spdRatio: 0.4, recRatio: 0.9 },
    { id: 'e3', name: 'Hivecore Coredrill', type: 'evo', icon: 'fa-dungeon', levelReq: 5.0, descReal: "Foreur : Fore à travers la défense adverse et l'expulse du combat.", descVirtual: "Kernel Panic : Force reboot sous-système.", atkRatio: 0.9, defRatio: 0.7, spdRatio: 0.6, recRatio: 0.5 },
    { id: 'e4', name: 'Hivecore Rhinovault', type: 'evo', icon: 'fa-chess-rook', levelReq: 6.5, descReal: "Colosse : Charge et frappe toutes les cibles à portée avec une force perforante.", descVirtual: "System Purge : Nettoyage disque complet.", atkRatio: 1.0, defRatio: 1.0, spdRatio: 0.7, recRatio: 1.0 },
